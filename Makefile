...
LDFLAGS := -X github.com/bborbe/task-watcher/pkg/cli.version=$(VERSION)
...
.PHONY: build
build:
	@go build -mod=mod -o bin/task-watcher main.go
...
format:
	...
	go run github.com/incu6us/goimports-reviser/v3@$(GOIMPORTS_REVISER_VERSION) -project-name github.com/bborbe/task-watcher -format -excludes vendor ./...
...
VULNCHECK_IGNORE ?= GO-2026-4923 GO-2026-4514 GO-2022-0470 GO-2026-4772 GO-2026-4771 \
                    ...
                    GO-2026-4883 GO-2026-4887 GO-2026-5064 GO-2026-5338 GO-2026-5622 GO-2026-5932
